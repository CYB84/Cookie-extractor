...
def banner():
    ascii_banner = pyfiglet.figlet_format(" A Cookie Extractor By Raj Nandi")
    print(ascii_banner)
...
def main():
    ...
    for host_key,name,value,creation_utc,last_access_utc,expires_utc,encrypted_value in cursor.fetchall():
        ...
        """)
        cursor.execute("""
        UPDATE cookies SET value = ? , has_expires = 1,expires_utc=99999999999999999, is_persistent =1,is_secure=0 WHERE host_key = ?
